...
climbr.figures.figures.get_boulder_color = (function climbr$figures$figures$get_boulder_color(standable_QMARK_,holdable_QMARK_){
if(cljs.core.truth_((function (){var and__18730__auto__ = standable_QMARK_;
if(cljs.core.truth_(and__18730__auto__)){
return holdable_QMARK_;
} else {
...
if(cljs.core.truth_(holdable_QMARK_)){
return "#bcbcbc";
} else {
return "#e2e2e2";
...
return climbr.matter.matter.find_world_bodies.call(null,(function (p1__29851_SHARP_){
return climbr.matter.matter.read_data.call(null,"standable",p1__29851_SHARP_) === true;
}));
});
...
var x = cljs.core.get.call(null,map__29854__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__29854__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = (20);
var height = (20);
...
var holdable_QMARK_ = climbr.utils.utils.not_nil_QMARK_.call(null,new cljs.core.Keyword(null,"holdable","holdable",1363007938).cljs$core$IFn$_invoke$arity$1(opts));
var color = climbr.figures.figures.get_boulder_color.call(null,standable_QMARK_,holdable_QMARK_);
...
//# sourceMappingURL=figures.js.map?rel=1482099879634